...
public class MessageJUnitTest {
	...
	{
		//message id should be autogenerated.  should not hard code. (check in other test cases also)
	...
	public void get_all_messages_by_reciever_failure()
	{
		...
		List<Message> messages=messageDAO.getAllMessages(message.getReceiverEmailId());
		//if the receiver does not exist, it shoud not return zero.  It should through error/null
